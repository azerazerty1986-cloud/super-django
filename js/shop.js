/* ================================================================== */
/* ===== [05] shop.js - نظام المتجر المتكامل (النسخة الكاملة) ===== */
/* ================================================================== */
...
const WishlistSystem = {
    ...
    showWishlist() {
        ...
        message += `━━━━━━━━━━━━━━━━\n📌 اضغط على المنتج لشرائه`;
        
        const productNames = this.items.map((item, i) => `${i+1}. ${item.name}`).join('\n');
        const choice = prompt(`${message}\n\n🔢 أدخل رقم المنتج للشراء (أو إلغاء):`);
